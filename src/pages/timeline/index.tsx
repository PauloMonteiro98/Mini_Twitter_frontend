        ...
        <div className="flex w-1/4 justify-end gap-4">
          {isGuest ? (
            <>
              <Link
                to="/register"
                className="flex h-10 items-center justify-center rounded-full border border-[#62748E] px-6 text-sm font-bold text-white transition-all hover:bg-white/5 whitespace-nowrap"
              >
                Registrar-se
              </Link>
              ...
              <Link
                to="/login"
                className="flex h-10 items-center justify-center rounded-full bg-twitter-blue px-8 text-sm font-bold text-white shadow-[0_4px_10px_rgba(13,147,242,0.3)] transition-all hover:bg-[#0B7DCE] whitespace-nowrap"
              >
                Login
              </Link>
            </>
